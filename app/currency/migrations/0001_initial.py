# Generated by Django 4.1.6 on 2023-04-09 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_logo', models.FileField(blank=True, default=None, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('currency', models.PositiveSmallIntegerField(choices=[(1, 'Euro'),
                                                                       (2, 'US Dollar'), (3, 'Hryvnia')], default=2)),
                ...
                ('source', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                             related_name='rates', to='currency.source')),
            ],
            options={
                'ordering': ('-created',),
            },
